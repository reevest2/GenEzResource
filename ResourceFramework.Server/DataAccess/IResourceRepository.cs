...
public interface IResourceRepository<T> where T : ResourceBase
{
    ...
    Task<T> FirstOrDefaultAsync(string? key1 = null, string? key2 = null, string? key3 = null, params Expression<Func<Resource<T>, bool>>[] filters);
    Task<List<T>> GetListByKeysAsync(string? key1 = null, string? key2 = null, string? key3 = null);
    Task<int> GetCountByKeysAsync(string? key1 = null, string? key2 = null, string? key3 = null, bool includeDeleted = false);
    Task<T> CreateResourceAsync(T data, string? key1 = null, string? key2 = null, string? key3 = null, string? ownerId = null);
